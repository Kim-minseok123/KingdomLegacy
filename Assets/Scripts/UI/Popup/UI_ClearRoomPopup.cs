...
public class UI_ClearRoomPopup : UI_Popup
{
    ...
    public override bool Init()
    {
        ...
        Managers.Sound.Play(Define.Sound.Effect, "Effect/º¸»ó", Managers.Game.EffectSound);
    ...
    public void GetGold() {
        ...
        Managers.Sound.Play(Define.Sound.Effect, "Effect/µ·", Managers.Game.EffectSound);
